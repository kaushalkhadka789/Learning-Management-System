...
const CreateLecture = () => {
  ...
  return (
    <div className='flex-1 mx-10'>
      <div className='mb-4'>
        <h1 className='font-bold text-xl'>Lets add lectures, add some basic lectures details for your new lecture</h1>
        <p className='text-sm'> Provide a clear lecture title and key details to begin shaping your learning material.</p>
      </div>
      <div className='space-y-4'>
        ...
        <div className="mt-10">
          {
            lectureLoading ? (<p>Loading lectures...</p>) : lectureError ? (<p>Failed to load lectures.</p>) : lectureData.lectures.length === 0 ? (<p>No lectures available.</p>) :
